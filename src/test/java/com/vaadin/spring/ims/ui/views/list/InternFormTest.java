...
public class InternFormTest {
    //private List<Company> companies;
    private Intern marcUsher;
...
//        companies.add(company2);
        ...
        marcUsher = new Intern();
        marcUsher.setFirstName("Marc");
        marcUsher.setLastName("Usher");
        marcUsher.setEmail("marc@usher.com");
    //    marcUsher.setStatus(Contact.Status.active);
...
//       Assert.assertEquals(Contact.Status.active, form.status.getValue());
//    }
...
//            Assert.assertEquals("VIT",savedContact.getCollegeName());
